...
public final class Post {
  ...
  @PersistenceCreator
  @JsonCreator
  public Post(String title, String content, LocalDateTime publishedOn, LocalDateTime updatedOn,
      AggregateReference<Author, Integer> author, Set<Comment> comments) {
    this.title = title;
    this.content = content;
